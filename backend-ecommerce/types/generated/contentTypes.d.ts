...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    back_camera: Schema.Attribute.Integer;
    battery_capacity: Schema.Attribute.Integer &
    ...
    color: Schema.Attribute.Enumeration<['Blanco', 'Negro', 'Gris']>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    currency: Schema.Attribute.Enumeration<['USD', 'EURO']> &
    ...
    front_camera: Schema.Attribute.Integer;
    ...
    > &
      Schema.Attribute.Private;
    microprocessor: Schema.Attribute.String;
    model: Schema.Attribute.String & Schema.Attribute.Unique;
    name: Schema.Attribute.String & Schema.Attribute.Unique;
    operating_system: Schema.Attribute.Enumeration<
    ...
    price: Schema.Attribute.Decimal &
      Schema.Attribute.SetMinMax<
        ...
        number
      >;
    product_status: Schema.Attribute.Enumeration<['Nuevo', 'Reacondicionado']>;
    ...
    ram: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        ...
        number
      >;
    screen_size: Schema.Attribute.Decimal &
      Schema.Attribute.SetMinMax<
        {
          min: 4;
        },
    ...
    stock: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        ...
        number
      >;
    storage_capacity: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        {
          min: 32;
        },
